                ...
                try {
                    ...
                    SwingUtilities.invokeLater {
                        ...
                        if (isCancelled.get()) {
                            ...
                            UIUtils.showResponsePanel(project, editor, panel, "Filewise Unit Test Cases")
                        }
                    }
                } catch (e: Exception) {
                    SwingUtilities.invokeLater {
                    ...
                    try {
                        ...
                        SwingUtilities.invokeLater {
                            ...
                            when (processedContent) {
                                is JPanel -> UIUtils.showResponsePanel(project, editor, processedContent, assistantType)
