    ...
    fun sendReviewRequest(apiUrl: String, text: String, language: String, authToken: String, projectName: String, branchName: String): String {
        return try {
            ...
            val jsonInputString = when {
                apiUrl.contains("/genieapi/assistant/code-generation") -> {
                    // Use "prompt" for Genie API
                    """
                    {
                        "prompt": "$safeText",
                        "language": "$language",
...
//                apiUrl.contains("/gitkbapi/get_code")
                apiUrl.contains("/gitkbapi/get_code") || apiUrl.contains("/gitkbapi/explain")-> {
                    // Use "question" for GitKB-style APIs
                    """
                    {
                        "question": "$safeText",
                        "language": "$language",
